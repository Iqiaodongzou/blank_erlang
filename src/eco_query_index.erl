...
prepare_format_index(Source) ->
    ...
    FinImg = <<"https://www.economist.com/sites/">>,
    MidImg = <<"http://54\\.190\\.52\\.30:8081/query/article\\?article_link=sites/">>,
    FinalIndex = iolist_to_binary(re:replace(PostIndex,MidImg,FinImg,[global])).
